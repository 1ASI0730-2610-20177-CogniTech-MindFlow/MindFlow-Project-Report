...
|---------|--------------|--------|-------------|----------------------------------|
| 1 | US01 | OAuth Registration (Google) | As a new user, I want to register using my Google account, so that I can access the platform quickly. | 3 |
| 2 | US02 | Traditional Login | As a user, I want to log in with email and password, so that I have a manual entry alternative. | 3 |
| 3 | US03 | Account Recovery | As a user, I want to reset my password via an email link, so that I don't lose my account if I forget it. | 3 |
| 4 | US04 | PIN Lock | As a user, I want to set a security PIN, so that I can protect my privacy from unauthorized physical access. | 2 |
| 5 | US05 | User Profile | As a user, I want to edit my personal details (name, occupation), so that the AI can personalize its language with me. | 2 |
| 6 | US06 | Dark Mode Interface | As a user, I want to enable dark mode, so that I can avoid eye strain during night use. | 2 |
| 7 | US07 | Account Deletion | As a user, I want to delete my account and purge my records, so that I can exercise my right to total privacy. | 3 |
| 8 | US08 (T) | AES-256 Encryption | As an architect, I want to implement encryption for journal entries in the DB, so that I can ensure total confidentiality. | 8 |
| 9 | US09 (T) | CI/CD Pipeline | As a developer, I want to configure an automated deployment flow, so that I can ensure fast and error-free deliveries. | 5 |
| 10 | US10 (T) | API Security (JWT) | As a developer, I want to implement JWT, so that I can secure backend requests and protect user data. | 3 |
| 11 | US11 | Journal Entry | As a student, I want to write free-text entries, so that I can vent my thoughts and feelings. | 3 |
| 12 | US12 | Real-time Sentiment Analysis | As a user, I want the AI to analyze my text upon saving, so that I can receive a classification of my current mood. | 5 |
| 13 | US13 | AI Empathetic Feedback | As a professional, I want to receive support from the AI after registering a mood, so that I feel immediate emotional validation. | 5 |
| 14 | US14 | Contextual Tags | As a user, I want to categorize my entries (Work, Family), so that I can identify which area stresses me the most. | 2 |
| 15 | US15 | Multimedia Attachment | As a user, I want to upload photos to my entries, so that I can have a visual record of significant moments. | 5 |
| 16 | US16 | Keyword Search | As a user, I want to search past entries by keywords, so that I can review specific life events. | 3 |
| 17 | US17 | Mood Calendar | As a user, I want to see a calendar with colors representing my mood, so that I can detect monthly emotional patterns. | 5 |
| 18 | US18 | Weekly AI Summary | As a user, I want to receive a mood summary every Sunday, so that I can reflect on my well-being throughout the week. | 5 |
| 19 | US19 (T) | LLM API Integration | As a developer, I want to connect the Gemini API, so that I can process natural language and generate empathetic responses. | 8 |
| 20 | US20 (T) | Sentiment Logging | As a developer, I want to log AI response metrics, so that I can improve the accuracy of the NLP model over time. | 2 |
| 21 | US21 | Create Habits | As a user, I want to define personalized goals, so that I can improve my daily self-care discipline. | 3 |
| 22 | US22 | Completion Check | As a user, I want to mark habits as completed, so that I can visualize my daily progress in real-time. | 2 |
| 23 | US23 | Stress-based Adjustment | As a professional with burnout, I want the app to reduce my workload if my mood is low, so that I don't feel overwhelmed. | 8 |
| 24 | US24 | Breathing Guide (4-7-8) | As a student, I want a visual 4-7-8 breathing exercise, so that I can calm down during peaks of anxiety. | 5 |
| 25 | US25 | Micro-meditations | As a user, I want to access short meditation guides, so that I can focus during my work breaks. | 3 |
| 26 | US26 | System Feedback | As a user, I want to rate the AI's advice, so that the system learns what helps me the most. | 2 |
| 27 | US27 | Hydration Alert | As a user, I want reminders to drink water, so that I don't neglect my physical health due to work. | 2 |
| 28 | US28 | Habit Streak | As a user, I want to see my historical streak, so that I stay motivated and disciplined. | 3 |
| 29 | US29 (T) | DB Indexing | As an engineer, I want to implement indexing on habits, so that the application loads lists quickly. | 3 |
| 30 | US30 (T) | Offline Cache | As a developer, I want local data persistence, so that the user can write in their journal without an internet connection. | 8 |
| 31 | US31 | Analytics Dashboard | As a user, I want to see bar charts of my emotions, so that I can understand my weekly ups and downs. | 5 |
| 32 | US32 | Word Cloud | As a user, I want to see my recurring keywords, so that I can identify my major stress triggers. | 5 |
| 33 | US33 | Premium Offers | As a user, I want to see a plan comparison, so that I can decide if I want to unlock extra features. | 2 |
| 34 | US34 | Secure Payment (Stripe) | As a user, I want to pay through a secure gateway, so that I can become Premium with total confidence. | 8 |
| 35 | US35 | Export PDF | As a Premium user, I want a structured PDF history, so that I can share it formally with my psychologist. | 5 |
| 36 | US36 | Export CSV | As a Premium user, I want to download my data in CSV, so that I can analyze it personally in Excel. | 3 |
| 37 | US37 | Technical Support | As a user, I want a direct help section, so that I can resolve technical questions about the application. | 3 |
